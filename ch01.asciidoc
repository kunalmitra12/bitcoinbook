...
**** Lightweight client - AKA simplified-payment-verification (SPV) client, connects to Bitcoin full nodes to access transaction information, stores user wallet locally, and creates/validates/transmits transactions, can interact directly with Bitcoin network without intermediary
